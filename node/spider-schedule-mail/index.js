...
function getSpiderData () {
    ...
    .then(spiderArr => {
        // spiderArr 数组 由promise resolve 出来的数组组成
...
function sendEmail (htmlData) {
    const template = ejs.compile(
        fs.readFileSync(path.resolve(__dirname,'email.ejs'),'ut8')
    )   
