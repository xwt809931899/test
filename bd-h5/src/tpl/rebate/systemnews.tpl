...
<head>
    ...
    <title>消息--_gConfig_.siteTitile</title>
    <link rel="stylesheet" href="../css/rebate/systemnews.css?@@version">
</head>
<body>
	...
	<header>
		...
		<h1>
			<div id="j-act-title" class="title">系统消息</div>
		</h1>
		<!-- <a href="/" class="home"></a> -->
	</header>
	...
	<!-- build:js ../js/rebate/systemnews.js -->
	...
	<script type="text/javascript" src="../js/rebate/_systemnews.js"></script>
