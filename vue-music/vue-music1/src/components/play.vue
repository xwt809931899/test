<template>
    <div class="play" v-show="playList.length>0">
        <!-- 播放页面 -->
        <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">              <!--transition一定要name-->
        <div class="normal-player" v-show="fullScreen">
            ...
            <div class="top">
                ...
                <h1 class="title" v-html="currentSong.name"></h1>    <!-- v-html就是用来给标签添加text内容-->
            ...
            <div class="mini-player" v-show="!fullScreen" @click="open">
                <div class="picture">
                    <div class="imgWrapper" ref="miniWrapper">
                        <img ref="miniImage" :class="cdCls" width="40" height="40" v-lazy="(currentSong.al && currentSong.al.picUrl) || (currentSong.artists && currentSong.artists[0].img1v1Url)">  <!-- v-lazy就可以放src -->
                    </div>
                </div>
                <div class="text">
